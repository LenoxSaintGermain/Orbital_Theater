...
/** Mock Stories for Orbital Theater */
export const MOCK_STORIES: Story[] = [
  {
    id: 'story-1',
    title: "The Mechanical Heartbeat",
    tagline: "A desolate world. A sleeping giant. A tiny caretaker.",
    author: "Third Signal",
    coverUrl: staticFilesUrl + 'Abstract_Cinematic_The_Mechanical_Heartbeat.mp4',
    tags: ['Sci-Fi', 'Atmospheric', 'Canon'],
    scenes: [
      {
        id: '1',
        title: 'The Gear',
        ...
        description: `The sequence begins with an extreme close-up of a single gear, slowly turning and reflecting harsh sunlight. The camera gradually pulls back in a continuous movement, revealing this is but one component of a colossal, mechanical heart half-buried in a desolate, rust-colored desert.`,
      },
      {
        id: '2',
        title: 'The Caretaker',
        type: 'canon',
        videoUrl: staticFilesUrl + 'Claymation_Robot_s_Existential_Crisis.mp4', // Reusing for demo
        description: `Inside the machine, a tiny robot performs meticulous maintenance. "Unit 734 reports... purpose undefined," it beeps, polishing a brass valve.`,
      }
    ]
  },
  {
    ...
    tagline: "From scene to postcard. A moment frozen in time.",
    author: "Zenith",
    coverUrl: staticFilesUrl + 'Kyoto_Serenity_From_Scene_to_Postcard.mp4',
    tags: ['Nature', 'Peaceful', 'Canon'],
    scenes: [
      {
        id: '9',
        title: 'Morning Light',
        ...
        description: `Soft morning light bathes a serene path in Kyoto. A small herd of wild sika deer gracefully wanders among the trees. As the deer lifts its head, the scene softens into a postcard.`,
      }
    ]
  },
  {
    id: 'story-3',
    title: "Neon Chase",
    tagline: "Run. Don't look back.",
    author: "CyberCore",
    coverUrl: staticFilesUrl + 'Video_Game_Trailer_Sci_Fi_Urban_Chasemp4.mp4',
    tags: ['Action', 'Cyberpunk', 'Remix'],
    scenes: [
      {
        id: '7',
        title: 'Alleyway',
        ...
        description: `A fast-tracking POV shot through a grimy, neon-lit cyberpunk alleyway at night. Rain slicks the pavement. Laser fire zaps past.`,
      }
    ]
  }
];

/** Videos for the gallery (Legacy/Flat view). */
