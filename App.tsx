...
/**
 * Main component for the Orbital Theater app.
...
export const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-void text-text-hi font-sans selection:bg-plasma selection:text-black">
      {editingVideo ? (
        <EditVideoPage
          video={editingVideo}
        ...
        <div className="mx-auto max-w-[1400px]">
          <header className="p-6 md:p-8 flex justify-between items-center border-b border-rim mb-8">
            <div className="flex items-center gap-4">
              ...
              <span className="hidden md:inline-block px-3 py-1 border border-rim rounded-full text-[10px] font-mono tracking-widest text-text-lo uppercase">
                Creator Studio
              </span>
            </div>
            <button 
              onClick={() => setView('landing')}
              className="text-xs font-mono tracking-widest text-text-mid hover:text-white uppercase"
            >
              Exit
            </button>
          </header>
          <main className="px-4 md:px-8 pb-8">
            <div className="mb-8 flex items-center gap-2">
               <div className="w-1 h-4 bg-verdant"></div>
               <h2 className="font-mono text-xs tracking-[0.2em] text-text-mid uppercase">WorldTree / Canon / Recent</h2>
            </div>
